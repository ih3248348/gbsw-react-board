...
export default function App() {
  ...
  return (
    <>
      <Header></Header>
      <div
        className={"min-h-screen bg-slate-50 px-5 pb-16 pt-24 text-slate-900"}
      >
        <div className={"mx-auto flex w-full max-w-5xl"}>
          <Routes>
            <Route
              path="/"
              element={
                <BoardListPage boards={boards} onDelete={handleDeleteBoard} />
              }
            />
            <Route
              path="/boards/new"
            ...
            <Route
              path="/boards/:id/edit"
              element={
                <BoardEditPage boards={boards} onUpdate={handleUpdateBoard} />
              }
            />
